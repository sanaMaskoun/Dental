        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('service_update', $service->id) }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label> {{ __('pages.service_name') }} <span
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label> {{ __('pages.description') }} <span
                                                    class="login-danger">*</span></label>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>{{ __('pages.service_pictures') }} <span
                                                    class="login-danger">*</span></label>
                                            ...
                                            @if ($service->getFirstMediaUrl('img'))
                                                <div style="margin-top: 10px;">
                                                    <img src="{{ $service->getFirstMediaUrl('img') }}" alt="Service Image"
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>{{ __('pages.specialization') }} <span
                                                    class="login-danger">*</span></label>
                                            <select class="form-control" name="specialization" required>
                                                <option value="" disabled selected>
                                                    {{ __('pages.specialization_select') }}</option>
                                    ...
                                    <div class="col-12">
                                        <div class="student-submit">
                                            <button type="submit"
                                                class="btn btn-primary">{{ __('pages.submit') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
